  ...
  function renderTable() {
    ...
    cache
      ...
      .forEach(c => {
        ...
        const waMsg = `Hola ${pNombre}, ¿cómo andás? Te escribimos desde JG Barbería porque hace días que no te vemos por acá. Cuando quieras renovar el look, acá te esperamos con el lugar. Estamos en Pellegrini 95, de lunes a sábado de 16 a 21 hs.`;
